...
public class LineAcceptanceStep {
    public static ExtractableResponse<Response> 지하철_노선_등록되어_있음(String name, String color, int extraCharge) {
        return 지하철_노선_생성_요청(name, color, extraCharge);
    }
    ...
    public static ExtractableResponse<Response> 지하철_노선_수정_요청(ExtractableResponse<Response> response, String name, String color, int extraCharge) {
        String uri = response.header("Location");
